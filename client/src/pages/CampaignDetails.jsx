  ...
  return (
    <div>
      ...
      <div className='w-full flex md:flex-row flex-col mt-10 gap-[30px]'>
        ...
        <div className='flex flex-row lg:flex-col md:w-[150px] w-full justify-between gap-[30px]'>
      ...
      <div className='flex flex-col lg:flex-row lg:gap-[300px]'>
          ...
          <div className='flex flex-col gap-4'>
            {donators.length > 0 ? donators.map((item, index) => (
              ...
              className='flex justify-between items-center gap-4'>
                ...
                <p className='font-epilogue font-normal text-[16px] text-[#b2b3bd] leading-[26px] break-ll'>{item.donation}</p>
              </div>
            )) : (
